        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Analyzing, cleaning, and visualizing complex datasets to derive
                actionable insights. From spreadsheets to dashboards, I make
                data tell a story.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              <h3>AI & WEB DEV</h3>
              <h4>Building AI-Driven Applications</h4>
              <p>
                Exploring the intersection of AI and web development. Building
